...
// Copyright (c) 2014 The DadCoin developers
...
bool fTxIndex = false;
static const int64 hexval = 2000000;
...
static const int64 nBlockRewardStartCoin = 200 * COIN;
static const int64 nBlockRewardLowCoin  = 40 * COIN;
static const int64 nBlockRewardHighCoin = 80 * COIN;
...
/*
    if (nHeight > 0 && nHeight < 401)
    {
       return nBlockRewardLowCoin;
    }
    if (nHeight > 400 && nHeight < 801)
    {
       return nBlockRewardHighCoin;
    }
*/
